			...
			<div className='container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700'>
				<div className='w-full lg:w-1/2 mx-8'>
					...
					<button
						...
						className=' cursor-pointer px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-black active:bg-black hover:bg-black'
					>
						back to homepage
					</button>
				</div>
